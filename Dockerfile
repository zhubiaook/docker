...
WORKDIR /go/src/github.com/zhubiaook/docker
...
RUN ln -sfv /go/src/github.com/zhubiaook/docker/.bashrc ~/.bashrc
...
RUN git config --global --add safe.directory $GOPATH/src/github.com/zhubiaook/docker
