...
package windows // import "github.com/zhubiaook/docker/daemon/graphdriver/windows"
	...
	if noreexec {
		defer func() {
			if err := winio.DisableProcessPrivileges([]string{winio.SeSecurityPrivilege, winio.SeBackupPrivilege, winio.SeRestorePrivilege}); err != nil {
				...
				// See https://github.com/zhubiaook/docker/pull/28002#discussion_r86259241 for rationale.
