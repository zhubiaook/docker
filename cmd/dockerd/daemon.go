...
import (
	...
	apiserver "github.com/zhubiaook/docker/api/server"
	buildbackend "github.com/zhubiaook/docker/api/server/backend/build"
	"github.com/zhubiaook/docker/api/server/middleware"
	"github.com/zhubiaook/docker/api/server/router"
	"github.com/zhubiaook/docker/api/server/router/build"
	checkpointrouter "github.com/zhubiaook/docker/api/server/router/checkpoint"
	"github.com/zhubiaook/docker/api/server/router/container"
	distributionrouter "github.com/zhubiaook/docker/api/server/router/distribution"
	grpcrouter "github.com/zhubiaook/docker/api/server/router/grpc"
	"github.com/zhubiaook/docker/api/server/router/image"
	"github.com/zhubiaook/docker/api/server/router/network"
	pluginrouter "github.com/zhubiaook/docker/api/server/router/plugin"
	sessionrouter "github.com/zhubiaook/docker/api/server/router/session"
	swarmrouter "github.com/zhubiaook/docker/api/server/router/swarm"
	systemrouter "github.com/zhubiaook/docker/api/server/router/system"
	"github.com/zhubiaook/docker/api/server/router/volume"
	...
	"github.com/zhubiaook/docker/cmd/dockerd/trap"
	"github.com/zhubiaook/docker/daemon"
	"github.com/zhubiaook/docker/daemon/cluster"
	"github.com/zhubiaook/docker/daemon/config"
	"github.com/zhubiaook/docker/daemon/listeners"
	"github.com/zhubiaook/docker/dockerversion"
	"github.com/zhubiaook/docker/libcontainerd/supervisor"
	dopts "github.com/zhubiaook/docker/opts"
	...
	"github.com/zhubiaook/docker/pkg/pidfile"
